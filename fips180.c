...
void sha2_256_init(struct SHA256_CTX *sha_256, uint8_t hash[SIZE_OF_SHA_256_HASH])
{
	sha_256->hash = hash;
...
{
	struct SHA256_CTX sha_256;
	sha2_256_init(&sha_256, hash);
	sha2_256_update(&sha_256, input, len);
	(void)sha2_256_finish(&sha_256);
}
